...
required <- c("tidyverse", "tidylog", "here", "janitor", "readxl", "digest", "rgbif")
...
distribution <-
  distribution |>
  mutate(dwc_countryCode = country_code) 
```
...
distribution <-
  distribution |>
  mutate(dwc_occurrenceStatus = occurrence_status) 
```
...
distribution <-
  distribution |>
  mutate(dwc_threatStatus = recode(threat_status,
    "endangered" = "EN",
    "vulnerable" = "VU"
  ))
```
...
distribution <-
  distribution |>
  mutate(dwc_occurrenceRemarks = remarks) 
```
